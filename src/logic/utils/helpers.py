...
SYN = {
    ...
    "GVO": ["GVO", "Gerente de Vendas e Operacoes", "Gerente de Vendas e Operações"],
    "GCVO": ["GCVO", "Gerente de Canal de Vendas e Operacoes", "Gerente de Canal de Vendas e Operações"],
    "GPVO": ["GPVO", "Gerente de Praca de Vendas e Operacoes", "Gerente de Praça de Vendas e Operações"],
    "ConsultorVendas": ["ConsultorVendas", "Consultor Vendas", "Consultor de Vendas", "Consultor_Vendas"],
    "Estoquistas": ["Estoquistas", "Estoquista", "Estoquista(s)"],
    "Seguranca": ["Seguranca", "Segurança", "Seguranca_Patrimonial", "Segurança Patrimonial"],
    "Analistas&Supervisores": ["Analistas&Supervisores", "Analistas & Supervisores", "Analises & Supervisores", "Análises & Supervisores", "Análise & Supervisores", "AnalisisSupervisores"],
    "Assistentes": ["Assistentes", "Assistente", "Assistente(s)"],
}
